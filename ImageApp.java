...
public class ImageApp
{
  public static void main(String[] args)
  {
    ...
    String pictureFile = "lib/dock-at-lake.jpg";
    String smallerPictureFile = "lib2/fish.png";
    ...
    for (int row = 0; row < recoloredPixels.length; row++) {
      for (int col = 0; col < recoloredPixels[0].length; col++) {
        ...
        recoloredPixels[row][col].setColor(new Color(p.getBlue(), p.getRed(), p.getGreen()));
      }
    }
